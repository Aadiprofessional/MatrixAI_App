...
import VoskTranscriptionScreen from './screens/VoskTranscriptionScreen.js';
                                ...
                                <ModalProvider>
                                    <NavigationContainer>
                                        <Stack.Navigator>
                                            ...
                                            />
                                            <Stack.Screen 
                                                name="AllMusicAiScreen" 
                                                component={AllMusicAiScreen} 
                                                options={{ headerShown: false }} 
                                            />
                                            <Stack.Screen 
                                            ...
                                            />
                                            <Stack.Screen 
                                                name="AllImagesAiScreen" 
                                                component={AllImagesAiScreen} 
                                                options={{ headerShown: false }} 
                                            />
                                            <Stack.Screen 
                                                name="SeeAllScreen" 
                                            ...
                                            />
                                            <Stack.Screen 
                                                name="VoskTranscriptionScreen" 
                                                component={VoskTranscriptionScreen} 
                                                options={{ headerShown: false }} 
                                            />
                                        </Stack.Navigator>
                                    </NavigationContainer>
